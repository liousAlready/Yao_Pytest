...
class SystemLocator:
    ...
    # #     新增用户 - 确认按钮
    # add_button = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[3]/div/div[2]/div/form/div[4]/div/button[2]')
    # #     点击离职按钮
    # quit_user_button = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div[4]/div[1]/div[3]/table/tbody/tr[1]/td[7]/div/button[2]/span')
    # #     离职二次确认按钮
    # quit_second_button = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div[4]/div[1]/div[3]/table/tbody/tr/td[7]/div/button[1]/span')
    # #     编辑用户群组
    # edit_user = (By.XPATH,'//*/div[1]/div[1]/ul/li[6]')
    # #     点击用户群组
    # edit_role_click = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[3]/div/div[2]/div/form/div[4]/div/button[2]/span')
    # #     选择新群组
    # edit_role_list_select = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div[4]/div[1]/div[3]/table/tbody/tr/td[5]/div/span')
    # #     修改按钮
    # edit_confirm = (By.XPATH,'//*[@id="app"]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div[4]/div[1]/div[3]/table/tbody/tr/td[4]/div')
    # #     离职
    # quit_text = (By.XPATH,)
    # #     当前所在群组
    # now_group = (By.XPATH,)
